...
const StatusPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const candidatesWithCompletedInterview = response.filter(candidate => candidate.candidateJobStatus.interviewCompleted === false);
            if (role === "interviewer") setCandidateData(candidatesWithCompletedInterview);
    ...
    const RecruiterButtonRender = (candidate) => {
        ...
        if (candidate.candidateJobStatus.interviewCompleted && !candidate.selected) return "Rejected";
        return "In Progress";
    }
