...
export const VIDEO_INTERVIEW_CALL_API = "ws://localhost:8082/";
export const VIDEO_INTERVIEW_CHAT_API = "ws://localhost:8082/chat/";
export const VIDEO_INTERVIEW_REST_API = "http://localhost:8082/";
